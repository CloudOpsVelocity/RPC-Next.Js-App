    ...
    <div className='w-full flex justify-between items-center bg-gradient-to-r  from-[#E0EBFF] /0 via-[#F0F6FF]/46  to-[#C9E8FF]/100 '>
        ...
        <p className="text-[15px] md:text-[20px] text-[#565D70] font-[500] mb-[1%]">
            ...
            <div className='flex justify-start items-end '>
                ...
                <div>
                    <p className=' text-[#148B16] text-[24px] md:text-[32px] lg:text-[40px] font-[700] '>Sumadhura</p>
                    <p className=' text-[#303A42] text-[14px] md:text-[16px] lg:text-[20px] font-[500] '>since January, 2017</p>
                </div>
            </div>

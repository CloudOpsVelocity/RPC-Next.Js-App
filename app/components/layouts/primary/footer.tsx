      ...
      <div className="w-full flex justify-between items-start flex-wrap flex-row ">
        <div className=" w-[100%]  lg:w-[30%] top-[64px] left-[104px] min-w-[202px] md:max-w-[350px] md:w-[60%] mb-[4%]">
          <Image
            ...
            alt="logo"
          />
          <p className=" top-[68px] left-0 [font-family:'Montserrat-Medium',Helvetica]  font-medium text-[#666666] text-[18px] leading-[26px]  xl:text-[20px] tracking-[0] xl:leading-[36px] mt-5">
            We pride ourselves on delivering exceptional customer services &amp;
            building lasting relationships with our clients
          </p>
        </div>

        <div className=" w-[10%] left-[653px] top-[64px] min-w-[180px] mb-[4%]">
        ...
        <div className=" w-[10%] left-[1013px]  top-[64px] min-w-[180px] mb-[4%]">

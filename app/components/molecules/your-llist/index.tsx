...
const YourList = () => {
  return (
    <div className="max-w-7xl mx-auto h-[580px] bg-white [background:linear-gradient(180deg,rgb(249,252,255)_0%,rgb(255,255,255)_100%)] mt-20">
      <div className="inline-flex items-center justify-center gap-[200px] relative top-[58px] left-[318px]">
        <Image className="relative w-[371.81px] h-[443.03px]" alt="Vector" src="/home/yourListingRight.svg" width={371.81} height={443.03} />
        <div className="inline-flex flex-col items-start gap-[45px] relative flex-[0_0_auto]">
          ...
          <div className="relative w-[712px] h-[325.16px]">
            <div className="inline-flex flex-col items-start gap-[32px] absolute top-0 left-0">

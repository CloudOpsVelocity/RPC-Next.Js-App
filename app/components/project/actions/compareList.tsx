...
export default function CompareList() {
  ...
  return (
    <button
      ...
      className={clsx(
        "flex justify-center items-center gap-1 p-2 rounded-lg border-[0.8px] mt-3 border-solid border-[#0073C6] bg-[#fafafa] text-[#0073C6] sm:text-base xl:text-[20px] xl:text-2xl not-italic font-semibold leading-[normal] tracking-[0.96px] sm:tracking-[0.4px]  xl:tracking-[0.96px]   sm:mt-2 xl:mt-5 text-[12px] text-nowrap",
        data?.compareAdded &&

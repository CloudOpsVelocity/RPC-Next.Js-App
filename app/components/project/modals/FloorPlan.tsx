    ...
    <div className="col-span-1 w-full max-w-[393px] ">
      ...
      {propCgId != projectprops.plot && 
        ...
        <Select
          w={"full"}
          mt="md"
          label={`${propCgId == projectprops.rowHouse || propCgId == projectprops.villa ? "Select Elevation" : "Select Floor"  }`}
          className="!w-[46%]"
          placeholder="-- select --"
          data={["1", "2", "3", "4", "5"]}
          searchable
        ...
        <Select
          w={"full"}
          mt="md"
          label={`${propCgId == projectprops.plot ? "Select Plot Facing" : "Select Facing"} `}
          className="!w-[46%]"
          placeholder="-- select --"
          data={["1", "2", "3", "4", "5"]}
          searchable
        ...
        {propCgId == projectprops.villament && propCgId != projectprops.plot &&
        <Select
          w={"full"}
          mt="md"
      ...
      <div className="bg-[#F4FBFF] p-6 rounded-lg shadow max-w-sm">
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="font-medium">{`${propCgId == projectprops.rowHouse || propCgId == projectprops.villa ? "Elevation" : "Floor"  }`}</span>
            <span>02</span>
          </div>
          }
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="font-medium">{`${propCgId == projectprops.plot ? "Plot Facing" : "Facing"} `}</span>
  ...
  return (
    <div className="col-span-1 w-full max-w-[686px]">
      <div className="relative">
        <p className="text-[#005DA0] text-[16px] font-[500] " >Sarang by sumadhura/2bhk/tower 1/ 04/north/1124 sq.ft</p>
        <img

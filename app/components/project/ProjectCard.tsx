      ...
      <div className="border text-card-foreground min-w-[350px] bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="text-sm">
            {type != "proj" &&
            <p className="text-[18px] font-[600] text-[#303030] mb-[8px] ">3BHK Villa for Sale in Varthur, <span className="text-[18px] font-[700] text-[#148B16] "> Rs 3.2 Lakh</span> </p>
            }
            ...
            {type != "proj" &&
            <p className="text-[16px] mb-[6px] font-[600] text-[#4D6677]">Available From: 12/ 02/ 2023</p>
            }
            ...
            {type != "proj" &&
            <p className="text-[16px] font-[500] text-[#4D6677]">Posted by Agent</p>
            }
            <Button
              icon={<Phone />}

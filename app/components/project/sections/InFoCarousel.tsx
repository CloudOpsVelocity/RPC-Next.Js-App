      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50 sticky top-0">
          <tr className="flex flex-row bg-[#00487C] justify-start items-center gap-3">
            <th className="w-[116px] justify-center text-center items-start gap-2.5 px-2.5 py-2 text-white text-[16px] not-italic font-bold leading-[normal] ">
              Unit Type
            </th>
            <th className=" w-[232px]  justify-center text-center items-start gap-2.5 px-2.5 py-2 text-white text-[16px] not-italic font-bold leading-[normal] ">
              Super Built- Up Area
            </th>
            <th className="w-[149px]  justify-center text-center items-start gap-2.5 px-2.5 py-2 text-white text-[16px] not-italic font-bold leading-[normal] ">
              Carpet Area
            </th>
            <th className=" w-[149px] justify-center text-center items-start gap-2.5 px-2.5 py-2 text-white text-[16px] not-italic font-bold leading-[normal] ">
              Unit Price
            </th>
            <th className=" w-[250px]  justify-center text-center items-start gap-2.5 px-2.5 py-2 text-white text-[16px] not-italic font-bold leading-[normal] ">
              Floor Plan
            </th>
          </tr>
        </thead>
        <tbody className="bg-white divide-y divide-gray-200">
          {data &&
            sortUnits(Object.keys(data)).map((item: any, index: number) => {
              ...
              return (
                <tr
                  key={index}
                  className="hover:bg-gray-100 flex flex-row justify-start items-start "
                >
                  <td
                    className=" w-[116px] justify-center text-center items-start gap-2.5 px-2.5 py-5 border-r-[0.5px] border-r-[#D9DFE3] border-b-[0.5px] border-b-[#D9DFE3] border-solid;
          bg-[#eef7ff]"
                  >
                    {item}
                  </td>
                  <td
                    className=" w-[232px]  justify-center text-center items-start gap-2.5 px-2.5 py-5 border-r-[0.5px] border-r-[#D9DFE3] border-b-[0.5px] border-b-[#D9DFE3] border-solid;
          bg-[#FFF]"
                  >
          ...
          bg-[#D9DFE3]"
                  ...
                  <td
                    className="w-[149px] justify-center text-center items-start gap-2.5 px-2.5 py-5 border-r-[0.5px] border-r-[#D9DFE3] border-b-[0.5px] border-b-[#D9DFE3] border-solid;
          bg-[#FFF]"
                  >
                  ...
                  <td
                    className="w-[250px]  justify-center text-center items-start gap-2.5 px-2.5 py-5 border-r-[0.5px] border-r-[#D9DFE3] border-b-[0.5px] border-b-[#D9DFE3] border-solid;
          bg-[#D9DFE3]"
                  >
                    <button

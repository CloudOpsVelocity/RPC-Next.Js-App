      ...
      <div className="w-[90%] bg-white py-10 mb-[5%]">
        <div className=" mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-4 ">
            ...
            <button className="inline-flex items-center justify-center text-[18px] lg:text-[20px] text-[#0073C6] font-[700] ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 mt-2">
              + 23 More
            </button>
          </div>
        </div>

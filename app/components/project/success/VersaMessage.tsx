...
export default function VersaMessage({
  ...
  return (
    <div className="flex w-full sm:h-[356px] xl:h-[467px] flex-col items-center gap-16 xl:gap-28 shrink-0 pb-[12px] xl:pb-[33px] rounded-[20px] bg-[#fff] border  overflow-hidden">

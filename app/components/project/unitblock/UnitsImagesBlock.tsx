...
const UnitsImagesBlock = ({
    ...
    const filteredUrlsArray = floorsArray.filter((eachObj: { floorPlanUrl: undefined; })=>eachObj.floorPlanUrl !== undefined);
    ...
    return(
        <>
            ...
            <div className="flex justify-between items-center w-full mt-[10px] mb-[10px] gap-[16px] ">
                ...
                <div ref={containerRef} className="flex justify-start scroll-smooth scrollbar-hide items-center w-full max-w-[800px] overflow-x-auto gap-[10px] ">

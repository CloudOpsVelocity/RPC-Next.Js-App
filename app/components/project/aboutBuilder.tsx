...
export default function AboutBuilder({ id, type = "proj" }: Props) {
  ...
  return (
    <div
      className="w-[95%] md:w-[90%] scroll-mt-[220px] mb-[5%]  md:mb-[2%] rounded shadow-[0px_4px_17.6px_0px_rgba(146,178,200,0.40)] border-[0.5px] border-solid border-[#92B2C8] builderBg pt-4 pb-4 md:pb-6 sm:py-8 sm:pl-5 px-2 sm:px-0 "
      id="aboutBuilder"
    >
      <div>
        <div className=" gap-[26px] justify-start  w-[100%] items-center">
          <h2 className=" text-[#242424] text-h2 sm:text-[24px] lg:text-[32px] font-[700] mb-2 xl:mb-4 ">
            About Builder
          </h2>

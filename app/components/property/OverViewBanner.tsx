      ...
      <div className="flex justify-start items-center w-full flex-col md:flex-row listingBannerBg">
        ...
        <div className="flex justify-center sm:justify-between items-center w-[100%] flex-row ml-[3%] p-[2%] flex-wrap">
          ...
          <div className="flex justify-center items-center flex-col">
            <button
              onClick={toggle}
              className=" p-5 mt-[13px]   text-[#0073C6] text-xl not-italic font-bold leading-[normal] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] rounded-[20px] bg-white flex justify-center items-center gap-1 px-3 py-3.5"
            >

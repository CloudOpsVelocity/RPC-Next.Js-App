    ...
    return (
        ...
        >
            <div 
                ...
                className={`relative bg-white flex flex-col overflow-y-auto shrink-0 z-[3] overflow-x-hidden min-h-[calc(100vh-70px)] h-full w-full md:w-[400px] xl:w-[560px] ${containerClassStyle ? containerClassStyle : ""} ${

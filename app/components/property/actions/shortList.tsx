...
export default function ShortList({ cg, propTypeName }: any) {
  ...
  return (
    <button
      ...
      className={clsx(
        "flex justify-center items-center gap-1 p-2 rounded-lg border-[0.8px] border-solid border-[#0073C6] bg-[#fafafa] text-[#0073C6] text-[12px] sm:text-[20px] xl:text-2xl not-italic font-semibold leading-[normal] sm:trackin-[0.4px] tracking-[0.96px] xl:tracking-[0.96px] text-nowrap mr-[10px] xl:mr-0 mb-[10px] xl:mb-0 ",
        data?.shortListed &&

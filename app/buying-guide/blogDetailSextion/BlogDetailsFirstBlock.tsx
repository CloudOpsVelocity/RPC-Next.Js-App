...
function BlogDetailsFirstBlock() {
  ...
  return (
    <div className='w-[94%] xl:w-[80%] flex flex-col md:flex-row justify-between items-center gap-[20px] mt-[5%] mb-[40px] md:mb-[5%] xl:mb-[160px] pt-[30px] md:pt-[50px] relative  '>
      <a href={"/buying-guide"} target="_blank">
      ...
      <div className='rounded-[10px] relative w-full md:w-[50%] max-h-[463px] border-[0.5px] border-gray border-solid  bg-white '>
        ...
        <TringleIcons key="TringleIcon2" className="absolute top-[20%] right-[-60px] z-10 xl:w-[167px] xl:h-[170px] w-[67px] h-[70px]" number={3} />
        <TringleIcons key="TringleIcon2" className="absolute top-[24%] right-[0] md:right-[-120px] z-10 xl:w-[105px] xl:h-[110px] w-[65px] h-[60px]" number={4} />
      ...
      <div className='w-full md:w-[45%] relative z-10 '>
          <h3 className={`text-[color:var(--800,#2D3748)] not-italic font-bold leading-[normal] mb-[12px] md:mb-[16px] xl:mb-[22px] text-[18px] md:text-[22px] lg:text-[30px]  `}>{heading}</h3>
          <p className={`text-[#01417C] italic font-medium leading-[normal] text-[14px] md:text-[16px] xl:text-[22px] mb-[12px] md:mb-[16px] xl:mb-[22px] `}>{text}</p>

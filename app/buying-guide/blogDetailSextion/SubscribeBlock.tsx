...
function SubscribeBlock() {
  return (
    <div className=' w-[94%] md:w-[90%] flex justify-around items-center mb-[3%] max-h-[220px] md:max-h-[100%] py-[30px] md:py-0 '>
        <div>
            ...
            <div className='border rounded-[10px] border-solid border-[#BBC9DD] bg-[#fcfcfc] h-auto md:h-[72px] p-[8px] md:p-[12px] xl:p-[16px] flex justify-between items-center gap-[10px] '>
                ...
                <button className='text-white text-[14px] md:text-[16px] xl:text-[20px] not-italic font-semibold leading-[normal] rounded-[4px] md:rounded-[10px] bg-[#227fbc] h-[32px] md:h-[40px] px-[12px] md:px-[14px] xl:px-[16px] '>
                    Submit
                </button>

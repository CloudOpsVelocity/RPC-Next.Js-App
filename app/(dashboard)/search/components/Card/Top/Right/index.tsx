...
const config = {
  shareIcon: (
    <div className="bg-[#ECF0F3]  rounded-full w-[26px] h-[26px]  flex  items-center">
      ...
      >
        <path
          d="M6.37492 8.5C6.37492 8.96966 6.18835 9.42007 5.85625 9.75217C5.52416 10.0843 5.07374 10.2708 4.60409 10.2708C4.13443 10.2708 3.68401 10.0843 3.35192 9.75217C3.01982 9.42007 2.83325 8.96966 2.83325 8.5C2.83325 8.03035 3.01982 7.57993 3.35192 7.24783C3.68401 6.91574 4.13443 6.72917 4.60409 6.72917C5.07374 6.72917 5.52416 6.91574 5.85625 7.24783C6.18835 7.57993 6.37492 8.03035 6.37492 8.5Z"
          stroke="#616D75"
          stroke-width="1.5"
        />
        <path
          d="M9.91667 4.60417L6.375 7.08333M9.91667 12.3958L6.375 9.91667"
          stroke="#616D75"
          stroke-width="1.5"
          stroke-linecap="round"
        />
        <path
          d="M13.4582 13.1042C13.4582 13.5738 13.2716 14.0242 12.9395 14.3563C12.6074 14.6884 12.157 14.875 11.6873 14.875C11.2177 14.875 10.7673 14.6884 10.4352 14.3563C10.1031 14.0242 9.9165 13.5738 9.9165 13.1042C9.9165 12.6345 10.1031 12.1841 10.4352 11.852C10.7673 11.5199 11.2177 11.3333 11.6873 11.3333C12.157 11.3333 12.6074 11.5199 12.9395 11.852C13.2716 12.1841 13.4582 12.6345 13.4582 13.1042ZM13.4582 3.89583C13.4582 4.36549 13.2716 4.81591 12.9395 5.148C12.6074 5.4801 12.157 5.66667 11.6873 5.66667C11.2177 5.66667 10.7673 5.4801 10.4352 5.148C10.1031 4.81591 9.9165 4.36549 9.9165 3.89583C9.9165 3.42618 10.1031 2.97576 10.4352 2.64367C10.7673 2.31157 11.2177 2.125 11.6873 2.125C12.157 2.125 12.6074 2.31157 12.9395 2.64367C13.2716 2.97576 13.4582 3.42618 13.4582 3.89583Z"
          stroke="#616D75"
          stroke-width="1.5"
        />
      </svg>

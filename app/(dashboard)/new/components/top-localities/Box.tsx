...
export default function Box({ id, name }: Props) {
  return (
    <a
      className="flex min-w-[240px] sm:min-w-[276px] flex-col items-center justify-center gap-[18px] text-[#242424]  text-base sm:text-[22px] not-italic font-semibold leading-[normal]"
      target="_blank"
    ...
    >
      <Image
        ...
        width={276}
        height={276}
        className="h-[240px] sm:h-[276px] self-stretch border-[color:var(--stroke-blue-gradient,#41D1D4)] shadow-[0px_4px_25px_0px_rgba(194,194,194,0.76)] rounded-full border-4 border-solid"
      />

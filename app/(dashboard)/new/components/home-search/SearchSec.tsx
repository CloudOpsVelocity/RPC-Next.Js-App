...
export default function SearchSec({}: Props) {
  ...
  /*  <Combobox.Dropdown className="min-w-[92%] !left-[4%] sm:!min-w-[410px] sm:!left-[32.5%] xl:!left-[44.5%] !z-[10] mt-1 absolute top-full">
    ...
    <div className={`${ isMobile ? "min-w-[92%] max-w-[92%] w-full " : "max-w-[calc(100% - 70%)]" } sm:max-w-[100%] !left-[4%] sm:!min-w-[410px] sm:!left-[32.5%] xl:!left-[44.5%]  mt-2 bg-white shadow-xl absolute z-10 max-h-[400px] overflow-y-auto `}>

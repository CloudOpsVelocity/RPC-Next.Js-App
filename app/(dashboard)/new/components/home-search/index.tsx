    ...
    >
      ...
      <div className="w-full">
        <div className="flex flex-col items-start sm:gap-3 self-stretch pl-[11px] pr-2.5 pt-0 pb-[13px] rounded-lg border-[0.5px] border-solid border-[#A6BDDF] bg-[#f2f7ff] sm:h-[200px] w-full">
          ...
          <p className=" flex justify-center items-center gap-[4px] sm:hidden text-[#0073C6] text-[10px] not-italic font-[700] mb-[5px] leading-[normal]">Bangalore {config.drpdownIcon}</p>
...
const config = {
  ...
  drpdownIcon:(
    <svg 
      ...
      xmlns="http://www.w3.org/2000/svg" width="3" height="5" viewBox="0 0 3 5" fill="none"
    >
      <path d="M0 4.29289C0 4.73835 0.538571 4.96143 0.853553 4.64645L2.64645 2.85355C2.84171 2.65829 2.84171 2.34171 2.64645 2.14645L0.853554 0.353554C0.538571 0.0385714 0 0.261654 0 0.707107L0 4.29289Z" fill="#0073C6"/>
    </svg>
  )
};

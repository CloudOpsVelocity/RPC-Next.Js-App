...
export default function ListingCard({ item }: Props) {
  ...
  return (
    <div className="w-full sm:w-[490px]">
      <div className="h-[228px] mb-[6px] shrink-0 shadow-[0px_4px_20px_0px_rgba(194,194,194,0.40)] relative">
        <a
      ...
      <div className="sm:min-h-[204px] self-stretch rounded shadow-[0px_4px_20px_0px_rgba(194,194,194,0.40)] border-[0.8px] border-solid border-[#A4B8B5] bg-[#FFF]">
        <div className="p-[10px] flex justify-between">
          <div className="space-y-1">
            ...
            <p className="text-[#148B16] text-[18px] sm:text-[20px] not-italic font-bold leading-[normal] capitalize">
        ...
        <div className="pl-3 mr-[14px] sm:mr-0">
          ...
          <p className="text-[#242424] text-sm not-italic font-semibold leading-[normal] capitalize mt-[6px] mb-[6px]">
...
const DownSectionCard = ({
  ...
  return (
    <div className="flex flex-col justify-center items-start ">
      ...
      <p className="text-[#242424] text-[12px] not-italic font-semibold">{value}</p>
    </div>
  );
};

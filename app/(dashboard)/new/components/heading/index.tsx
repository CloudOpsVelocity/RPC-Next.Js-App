...
export default function MainHeading({ title, content, className }: Props) {
  const url =
    title === "Featured Projects"
      ...
      ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/search/listing?propStatus=R`
      : title === "Ready to Move Rent Listings"
      ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/search/listing?cgh=R&propStatus=R`
      ...
      ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/search/listing?listedBy=I`

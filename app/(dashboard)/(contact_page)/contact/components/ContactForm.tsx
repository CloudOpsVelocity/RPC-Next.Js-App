  ...
  return (
    ...
    >
      <label htmlFor="name" className="w-full">
        <p className="text-[#333] text-base not-italic font-semibold text-left">
          Full Name
        </p>
        <input
          id="name"
          ...
          type="text"
          className="rounded-[5px] border-[0.5px] border-solid border-[#666] bg-white text-[16px] placeholder:text-[#767270] px-2 py-1 w-full"
      ...
      <button
        type="submit"
        className="justify-center items-center gap-2 text-white text-base not-italic font-semibold leading-[normal] p-2 rounded-[5px] bg-[#0073c6]"
      >
        Submit
      </button>
    </form>

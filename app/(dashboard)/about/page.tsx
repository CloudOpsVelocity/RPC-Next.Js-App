    ...
    const profiles = [
        {
            ...
            name: "Manish Kumar",
            place: "Bangalore",
            comment: "Get Right Property made finding my new home effortless! The platform is user-friendly, with up-to-date listings and easy navigation.!"
        },
        {
            profile: "Profile2",
            name: "Aayushi Dwivedi",
            place: "Bangalore",
            comment: "Get Right Property simplified my home search with its easy-to-use interface and up-to-date listings!"
        },
        {
            profile: "Profile3",
            name: "Ramya Krishnan",
            place: "Bangalore",
            comment: "Get Right Property made inquiring about projects easy, with quick and helpful responses every time!"
        }
    ];
         ...
         {/*About */}
            <div className='flex sm:flex-row items-center justify-start w-full gap-[4%] mb-5 sm:mb-0 sm:max-w-[80%] mx-auto flex-col-reverse max-w-full'>
                <div className='content flex flex-col justify-start items-center sm:items-start max-w-[97%] sm:max-w-[60%] '>
                    <h1 className='text-[#003] font-[Montserrat] text-[16px] text-center sm:text-[20px] xl:text-[26px] not-italic font-bold leading-[normal] sm:pt-[10px] xl:pt-[20px]'><span className='text-[#2AA327] '>About</span> Get Right Property</h1>
                    <p className='text-[#003] font-[Montserrat]  leading-[18px] sm:mt-[8px] text-[14px] text-center sm:text-left  sm:text-[15px] xl:text-[20px] not-italic font-normal sm:leading-[26px] sm:pt-[10px] pt-[20px] break-words  '>Get Right Property is your ultimate real estate companion, designed to streamline buying, selling, and property exploration. Our app allows users to effortlessly post properties and inquire about those of interest. With a user-friendly interface, you can list your property, search for available listings, and browse a diverse range of options.</p>
                    <p className='text-[#003] font-[Montserrat] leading-[18px] text-[14px] text-center sm:text-left  sm:text-[15px] xl:text-[20px] not-italic font-normal sm:leading-[26px] pt-[12px] sm:pt-[10px] xl:pt-[20px] break-words'>Connect with buyers, sellers, and agents seamlessly, and stay updated with the latest real estate news and trends. Whether you're looking to advertise, find your dream home, or simply explore the market, Get Right Property offers a comprehensive platform for all your real estate needs. Experience a smarter way to navigate property transactions and make informed decisions with ease.</p>
                    <a className='text-[#FFF] mt-[14px] px-[10px] py-[6px] text-[13px] sm:mt-[20px] xl:mt-[34px] font-[Montserrat] sm:text-[17px]  xl:text-[20px] not-italic font-bold leading-[normal] sm:px-[20.514px] sm:py-[13.676px] justify-center items-center gap-[7.598px] rounded-[4px] bg-[#0073C6]' href={url} target='_blank'>
                    Explore Now
                    </a>
                </div>
                <img 
                ...
                src={"https://daxv8eiot4y5y.cloudfront.net/About%20us/hero-image.png"}
                />
            </div> 
            {/* best services */}
                    ...
                    <div className=' pt-[20px] pb-[20px] sm:pt-[60px] sm:pb-[60px]'>
                        ...
                        <div className='flex flex-col gap-[12px] mt-4 sm:mt-8'>
                            <div className='flex flex-row items-center justify-start gap-1 '>
                                {greenTick}
                                <p className='text-[#242424] font-[Montserrat] text-[14px]  sm:text-[14px] xl:text-[18px] not-italic font-medium leading-[normal]'>Post your Listing for Free</p>
                            </div>
                            <div className='flex flex-row items-center justify-start gap-1 '>
                                {greenTick}
                                <p className='text-[#242424] font-[Montserrat]  text-[14px]   sm:text-[14px] xl:text-[18px] not-italic font-medium leading-[normal]'>Post your Listing for Free</p>
                            ...
                            <div className='flex flex-row items-center justify-start gap-1 '>
                                {greenTick}
                                <p className='text-[#242424] font-[Montserrat]  text-[14px]  sm:text-[14px] xl:text-[18px] not-italic font-medium leading-[normal]'>Set property alerts for your requirement</p>
                            </div>
                            <div className='flex flex-row items-center justify-start gap-1 '>
                                {greenTick}
                                <p className='text-[#242424] font-[Montserrat] text-[14px]   sm:text-[14px] xl:text-[18px] not-italic font-medium leading-[normal]'>Showcase your property as Rental, or for Sell</p>
                            </div>
                            <div className='flex flex-row items-center justify-start gap-1 '>
                                {greenTick}
            ...
            <div className='flex flex-col sm:flex-row  justify-center  items-center sm:items-start gap-[5%] mt-7'>
                ...
                <div className='flex flex-col justify-center items-center sm:items-start '>
                    <h1 className='text-[#000] font-[Montserrat] text-[16px] text-center sm:text-left sm:text-[20px] xl:text-[24px] not-italic font-semibold leading-[normal] mb-1'>Rahul Vishwakarma</h1>
                    <h3 className='text-[#767270] font-[Montserrat] text-[16px] text-center sml:text-left sm:text-[16px] xl:text-[20px] italic font-semibold leading-[normal]'>Founder, Get Right Property</h3>
                    <p className='text-[#003] font-[Montserrat] leading-[21px] text-center sm:text-left text-[14px] sm:text-[15px] xl:text-[20px] not-italic font-normal sm:leading-[26px] mt-4'>At Get Right Property, we're dedicated to reshaping real estate through cutting-edge professionalism training and collaborative environments. Our commitment to comprehensive market analysis and innovative solutions drives us. With a focus on results and maximizing sales potential, we're rewriting industry norms and surpassing client needs.</p>
                    <p className='text-[#003] font-[Montserrat]  text-center sm:text-left leading-[21px] text-[14px] sm:text-[15px]  xl:text-[20px] not-italic font-normal sm:leading-[26px] pt-3'>Join us in this journey to redefine excellence in real estate. Together, let's create a future where every transaction is exceptional and every client's dream finds its perfect home.</p> 
                </div>
            </div>
            </div>
            {/*prefect solution */}
            <div className='flex flex-col justify-center pt-[20px] sm:justify-start items-center sm:items-start  sm:pb-[60px] xl:pb-[80px]   max-w-full  mx-auto  sm:mt-[50px] xl:mt-[60px] bg-[#fff]'>
                <h1 className='text-[#003] font-[Montserrat] leading-[21px] flex flex-col sm:flex-row sm:justify-center gap-2 sm:items-center sm:max-w-[80%] text-[14px] sm:text-[20px] xl:text-[26px] mt-1 not-italic font-bold sm:leading-[normal] sm:mt-2 mx-auto capitalize'>The Perfect Solution to <span className='text-[#2AA327] '>Best Project Finding</span></h1>
                <p className='text-[rgba(0,_0,_51,_0.95)] mx-auto font-[Montserrat] sm:mt-[8px]  sm:max-w-[80%] text-[14px] sm:text-[16px] xl:text-[20px] not-italic font-normal leading-[21px] text-center sm;text-left sm:leading-[26px]'>The perfect solution for finding the best projects. Our platform offers a seamless search experience, detailed listings, and real-time updates, making your project discovery quick and effortless.</p>
                    <div className='flex flex-row gap-[2%] w-full pb-[20px] sm:pb-0 overflow-x-scroll sm:overscroll-x-none mt-8 sm:mx-auto  sm:max-w-[80%]  sm:scrollbar-hide'>
                        <div className='w-[235px] h-[293px] sm:h-auto flex-shrink-0 sm:w-[30%]  sm:max-w-[30%] p-3 sm:p-6 xl:p-12 rounded-[20px] justify-center border-[1px] border-[solid] border-[rgba(194,194,194,0.60)] bg-[#FFF]           [box-shadow:0px_10px_25px_0px_rgba(194,_194,_194,_0.44)]'>
                           <div className=' w-[65.105px] h-[53px] rounded-[4px] flex justify-center items-center bg-[rgba(2,_152,_55,_0.10)] p-auto'><BuildingIconABout /> </div>
                                <h1 className='text-[#003] font-[Montserrat] text-[14px] sm:text-[15px] xl:text-[20px] not-italic font-bold leading-[30px] mt-4'>Newly Launched Projects</h1>
                                <p className='text-[rgba(0,_0,_51,_0.95)] font-[Montserrat] text-[12px] sm:text-[15px] not-italic font-medium leading-[21px] sm:leading-[26px] mt-3  mb-4    sm:mb-10'>Discover the latest in real estate with our newly launched projects. Explore innovative projects and find your perfect new home today. </p>
                        ...
                        <div className=' w-[235px] h-[293px]  sm:h-auto flex-shrink-0  sm:w-[30%] sm:h-[autopx] max-w-[60%] sm:max-w-[30%]  p-3  sm:p-6 xl:p-12 rounded-[20px] justify-center border-[1px] border-[solid] border-[rgba(194,194,194,0.60)] bg-[#FFF]           [box-shadow:0px_10px_25px_0px_rgba(194,_194,_194,_0.44)]'>
                           <div className=' w-[65.105px] h-[53px] rounded-[4px]  flex justify-center items-center bg-[rgba(2,_152,_55,_0.10)] p-auto'><BuildingIconABout /> </div>
                                <h1 className='text-[#003] font-[Montserrat] text-[14px] sm:text-[15px] xl:text-[20px] not-italic font-bold leading-[30px] mt-4'>Completed Projects</h1>
                                <p className='text-[rgba(0,_0,_51,_0.95)] font-[Montserrat] text-[12px] sm:text-[15px] not-italic font-medium leading-[21px] sm:leading-[26px] mt-3  mb-4 sm:mb-10'>Explore our completed projects and find beautifully finished homes ready for you. Discover quality craftsmanship and move-in-ready projects now. </p>
                        ...
                        <div className=' w-[235px] h-[293px]  sm:h-auto flex-shrink-0 sm:w-[30%] sm:h-[autopx] max-w-[60%] sm:max-w-[30%] p-3  sm:p-6 xl:p-12 rounded-[20px] justify-center border-[1px] border-[solid] border-[rgba(194,194,194,0.60)] bg-[#FFF]           [box-shadow:0px_10px_25px_0px_rgba(194,_194,_194,_0.44)]'>
                           <div className=' w-[65.105px] h-[53px] rounded-[4px] text-[14px] flex justify-center items-center bg-[rgba(2,_152,_55,_0.10)] p-auto'><BuildingIconABout /> </div>
                                <h1 className='text-[#003] font-[Montserrat] text-[14px] sm:text-[15px] xl:text-[20px] not-italic font-bold leading-[30px] mt-4'>Ongoing Projects</h1>
                                <p className='text-[rgba(0,_0,_51,_0.95)] font-[Montserrat] text-[12px] sm:text-[15px] not-italic font-medium leading-[21px] sm:leading-[26px] mt-3  mb-4  sm:mb-16'>Check out our ongoing projects for future-ready homes. Stay updated on construction progress and secure your ideal projects early. </p>
                                <a href='https://www.getrightproperty.com/search?projStatus=106'  target='_blank' className='ursor-pointer rounded-[4px] border-[1.618px] border-[solid] border-[#0073C6] px-[16.594px] py-[11.063px] justify-center items-center '>Explore Now</a>
                     </div>  
                </div>
            </div>
            {/* */}
            <div className='h-auto flex flex-col items-center relative min-w-[100%]  bg-[#F3FFF2]'>
                  <Illustrationcircles className='hidden sm:block z-[] absolute top-0 right-0 mb-8'/>
                    ...
                    <h1 className='text-[#003] font-[Montserrat] mt-5 sm:mb-8 sm:text-[20px] xl:text-[26px]  not-italic font-bold leading-[normal] mx-auto capitalize'>What our <span className='
                            ...
                            return(
                                ...
                                <div className='flex flex-row gap-2 justify-between   '> 
                                  ...
                                  <img 
                                      ...
                                      src={"/youtube.png"}
                                      />
                                       <p className='text-[#003] font-[Montserrat] text-[16px] sm:text-[18px] not-italic font-bold  leading-[19.5px]'> {each.name}<br/><span className = "text-[#767676] font-[Montserrat] text-[16px] not-italic font-medium leading-[19.5px]">{each.place}</span></p>
                                  </div>  
                                  <p className='text-[#029837] font-[Mulish] text-[48px] not-italic font-bold leading-[40px]'>“</p>
                              </div>
                              <p className='text-[rgba(0,_0,_51,_0.95)] font-[Montserrat] leading-[19px] text-[12px] sm:text-[16px] not-italic font-normal sm:leading-[22px] mt-2 pl-2'>{each.comment}</p>
                          </div>
                            )
                        })}
                    </div>
                ...
                <div className='hidden sm:block max-full '>
                 ...
                 <h1 className='font-[Montserrat] text-[16px] not-italic font-bold leading-[normal]'>
                    ...
                    <input
                        ...
                        placeholder='Enter your mail for new blog  '
                        />
                        <button className='text-[#FFF]   font-[Montserrat] text-[16px] sm:text-[20px] not-italic font-semibold leading-[normal] flex p-[9px]  justify-center items-center gap-[8px] rounded-[10px] bg-[#227FBC] ' name="Subscribe button">Sumbit</button>

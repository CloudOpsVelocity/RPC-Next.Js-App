         ...
         {/*About */}
            ...
            <div className='flex flex-row justify-center items-start gap-[5%] mt-7'>
                ...
                <div className='flex flex-col justify-center items-start '>
                    ...
                    <p className='text-[#003] font-[Montserrat] text-[20px] not-italic font-normal leading-[26px] mt-4'>At Get Right Property, we're dedicated to reshaping real estate through cutting-edge professionalism training and collaborative environments. Our commitment to comprehensive market analysis and innovative solutions drives us. With a focus on results and maximizing sales potential, we're rewriting industry norms and surpassing client needs.</p>
                    <p className='text-[#003] font-[Montserrat] text-[20px] not-italic font-normal leading-[26px] pt-3'>Join us in this journey to redefine excellence in real estate. Together, let's create a future where every transaction is exceptional and every client's dream finds its perfect home.</p> 
                </div>
            </div>
            </div>
            {/*prefect solution */}
            <div className='flex flex-col justify-start items-start max-w-[80%] mx-auto  mt-[60px]'>
                ...
                <p className='text-[rgba(0,_0,_51,_0.95)] mx-auto font-[Montserrat] text-[20px] not-italic font-normal leading-[26px]'>The perfect solution for finding the best projects. Our platform offers a seamless search experience, detailed listings, and real-time updates, making your project discovery quick and effortless.</p>
                    <div className='flex flex-row gap-[2%] mt-8 mx-auto'>
                        ...
                        <div className='h-[autopx] max-w-[30%] p-12 rounded-[20px] justify-center border-[1px] border-[solid] border-[rgba(194,194,194,0.60)] bg-[#FFF]           [box-shadow:0px_10px_25px_0px_rgba(194,_194,_194,_0.44)]'>
                           <div className=' w-[65.105px] h-[53px] rounded-[4px] flex justify-center items-center bg-[rgba(2,_152,_55,_0.10)] p-auto'><BuildingIconABout /> </div>
                                ...
                                <a href='https://www.getrightproperty.com/search?projStatus=106'  target='_blank' className='cursor-pointer rounded-[4px] border-[1.618px] border-[solid] border-[#0073C6] px-[16.594px] py-[11.063px] justify-center items-center '>Explore Now</a>
                     </div>  
                </div>
            </div>
            {/* */}
            <div className='h-auto flex flex-col items-center relative min-w-[100%] mt-[80px]  bg-[#F3FFF2]'>
                  <Illustrationcircles className=' absolute top-0 right-0 mb-8'/>

                    <h1 className='text-[#003] font-[Montserrat] mt-5 text-[26px]  not-italic font-bold leading-[normal] mx-auto capitalize'>What our <span className='
            ...
            <div className='max-w-[60%] mt-16 mb-24 flex flex-row mx-auto justify-between items-center gap-3'>
                <div className=' '>
                    <h1 className='font-[Montserrat] text-[24px] not-italic font-bold leading-[normal]'>
                    Subscribe To Our Newsletter
                    </h1>
                    <p className='text-[#303030] font-[Montserrat] text-[20px] italic font-medium leading-[normal]'>
                    ...
                    <div className='inline-flex mt-10 p-[16px]  w-[592px] justify-between items-center gap-[8px] rounded-[10px] border-[1px] border-[solid] border-[#BBC9DD] bg-[#FCFCFC]'>
                        <input
                        className='outline-none w-full text-[#666] font-[Montserrat] text-[20px] italic font-medium leading-[normal]'

  ...
  return (
    <div className="w-[90%]">
      <div className="w-full justify-between items-center ">
        ...
        <p className=" text-[#148B16] italic text-[26px] font-[700]">
          SARANG BY SUMADHURA
        </p>
        <div className="rounded-[20px] mt-[1%] flex justify-between items-center bg-[#FFF] shadow-md w-[50%] p-[1%] ">
          <div className="w-[30%] border-solid border-[#92B2C8] border-r-[1px]">
            <p className=" text-[#202020] text-[24px] font-[600]">05</p>
            <p className=" text-[#148B16] text-[20px] font-[700]">
              New Launch Projects
            </p>
          </div>

          <div className="w-[30%] border-solid border-[#92B2C8] border-r-[1px]">
            <p className=" text-[#202020] text-[24px] font-[600]">15</p>
            <p className=" text-[#0073C6] text-[20px] font-[700]">
              New Launch Projects
            </p>
          </div>
        ...
        <p className=" text-[#2A4C70] text-[20px] font-[700] mt-[1%] italic ">

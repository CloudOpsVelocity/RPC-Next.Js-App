  ...
  return (
    <div className='relative p-[3%] w-full h-[140px] md:h-[160px] lg:h-[200px] flex flex-col justify-center items-center bg-gradient-to-r from-gray-500 to-[#cccccc] overflow-hidden animate-gradient'>
        ...
        <div className="relative flex flex-col items-start justify-start h-full ml-0 md:ml-[30px] xl:ml-[40px] ">
          <p className='border-0 py-[4px] px-[6px] md:py-[6px] md:px-[8px] bg-blue-500 text-[10px] md:text-[12px] text-white mr-auto mb-[8px] md:mb-[16px] '>Residential</p>
          <h2 className='text-[16px] md:text-[22px] xl:text-[28px] text-white leading-[22px] md:leading-[26px] xl:leading-[30px] shadow-[2px 2px 5px rgba(0, 0, 0, 1)] mb-[8px] md:mb-[16px] font-bold '>Karnataka Govt. slashes stamp duty for properties priced under Rs 45 lakh</h2>
          <span className='text-[11px] text-[#cccccc] font-semibold'>Research Analyst</span>
          <span className='text-[11px] text-[#cccccc] font-semibold'>getrightproperty.com</span>
        </div>
        }
    </div>
  )

...
function ModalBox({children, isOpen, handleChange}: Props) {
    ...
    return (
        ...
        >
            <div id='modalPopupInnerCon' className="relative bg-white flex flex-col overflow-y-auto shrink-0 z-[3] overflow-x-hidden max-h-[90%] h-full w-[94%] p-[2%] pt-[36px] rounded-[4px] justify-center items-center">
                <button

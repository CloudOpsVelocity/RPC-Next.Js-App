      ...
      >
        ...
        >
          ...
          classNames={{
            ...
            onBlurCapture={ (e) => handleTrimAndReplace(e, `${id}.${index}.name`, form)}
...
{fields}
 ...
 {fields.length < 3 && <button  onClick={() =>
      form.insertListItem(id, { name: '', active: false, key: randomId() })
    } className=" ml-auto flex justify-end mt-1 bg-blue-500 hover:bg-blue-700 text-white font-normal text-[12px] py-[1px] px-[2px] rounded focus:outline-none focus:shadow-outline" type="button">Add More</button> } 
</Box>
  )
}
...
const allPoints = [
    {
        ...
        icon: <svg version="1.2" className={styles.svgStyle} baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
        ...
        icon: <svg className={styles.svgStyle} width="150px" height="150px" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none"><path stroke="#000000" stroke-linecap="round" stroke-linejoin="round" strokeWidth="12" d="M92.953 57.154c22.628-22.627 57.983-35.355 76.368-33.94 1.414 18.384-11.314 53.74-33.941 76.367-22.628 22.627-48.084 39.598-62.226 45.255L47.698 119.38c5.657-14.142 22.628-39.598 45.255-62.226Zm-5.657 48.084-39.598 39.598"/><circle cx="128.309" cy="64.225" r="12" fill="#000000" transform="rotate(45 128.309 64.225)"/><path stroke="#000000" stroke-linecap="round" stroke-linejoin="round" strokeWidth="12" d="m115.581 119.38 1.569 17.256c.779 8.57-3.09 16.9-10.139 21.835l-16.886 11.82-1.414-32.527M73.154 76.953l-17.256-1.569a24 24 0 0 0-21.835 10.139l-11.82 16.886 32.527 1.414"/></svg>
    },
    {
   ...
   <g>
    ...
    },
    {
        ...
        icon: <svg className={styles.svgStyle} fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
        width="150px" height="150px" viewBox="0 0 137 256" >
   <path d="M39,49.3H27.2c0-15.2,12.4-27.6,27.6-27.6v11.8C46,33.5,39,40.6,39,49.3z M43.6,194.3l-2.7-7.3l-1.5,0.6
    ...
    },
    {
        ...
        icon: <svg className={styles.svgStyle} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
   ...
   <g>
    ...
    },
    {
        ...
        points:["Allow potential buyers to view the property at various times, including evenings and weekends."],
        icon: <svg className={styles.svgStyle} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        viewBox="0 0 495.815 495.815" >
   <g>
       <g>
           <path  d="M488.54,394.903c-19.876-16.557-43.646-40.701-47.388-50.244
           ...
           <path  d="M368.841,134.995c22.784,0,41.251-18.469,41.251-41.25c0-22.78-18.467-41.25-41.251-41.25
               c-22.773,0-41.249,18.47-41.249,41.25C327.592,116.526,346.064,134.995,368.841,134.995z"/>
           <path d="M161.823,163.339c-6.205,0-11.235,5.03-11.235,11.235c0,3.247,1.386,6.164,3.588,8.215
    ...
    },
    {
        ...
        icon: <svg className={styles.svgStyle} width="150px" height="150px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M43 33V19H5V41C5 42.1046 5.89543 43 7 43H24" stroke="#000000" strokeWidth="4" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M5 10C5 8.89543 5.89543 8 7 8H41C42.1046 8 43 8.89543 43 10V19H5V10Z" stroke="#000000" strokeWidth="4" stroke-linejoin="round"/>
        <path d="M16 5V13" stroke="#000000" strokeWidth="4" stroke-linecap="round"/>
        <path d="M32 5V13" stroke="#000000" strokeWidth="4" stroke-linecap="round"/>
        <circle cx="30" cy="32" r="7" fill="#2F88FF" stroke="#000000" strokeWidth="4"/>
        <path d="M36 37L42 42" stroke="#000000" strokeWidth="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    },

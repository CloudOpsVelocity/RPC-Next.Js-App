...
function BlogThirdBlock() {
    ...
    return (
        <div className='w-[94%] md:w-[90%] flex flex-col md:flex-row justify-between items-center border shadow-[0px_5px_4px_0px_rgba(221,221,221,0.25)] rounded-[5px] border-solid border-[#E2E2E2] bg-white mb-[3%]'>

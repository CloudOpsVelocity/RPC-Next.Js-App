        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="max-w-[105px] ml-auto sm:ml-[0] 
            ...
            {isDropdownOpen && (
              <div
                className="absolute right-0  rounded-lg shadow-lg py-1 z-20 mt-2 w-48 bg-white  border border-white"
              >
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${getSortyByValue(state) === option.label
                        ? "text-white bg-[#0073C6]" : "text-gray-700 hover:bg-[#0073C6] hover:text-white"}
                    `}
                  >
                    {option.label}
                  </button>

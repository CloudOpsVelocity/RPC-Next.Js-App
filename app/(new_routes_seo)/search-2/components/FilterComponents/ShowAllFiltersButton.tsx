...
export default function ShowAllFiltersButton({ selectedFilters, toggleFilter, isOpen, onToggle }: ShowAllFiltersButtonProps) {
  ...
  const locations: Location[] = [
    ...
    {name: "Whisdfasdftefasdffield", stringUrl: null, stringId: "563", type: "Locality"},
    {name: "Whitesafdssffield", stringUrl: null, stringId: "563", type: "Locality"}
  ...
  const builders: Location[] = [
    {name: "Projects of Mana Projects", stringUrl: null, stringId: "35", type: "BuilderProject"},

    {name: "Projects of Mana Projects", stringUrl: null, stringId: "35", type: "BuilderProject"},

    {name: "Mana Projects", stringUrl: "/builders/bengaluru/mana-projects", stringId: "9_35",type: "BuilderProject"},

    {name: "Projects of Mantri", stringUrl: null, stringId: "16", type: "BuilderProject"},

    {name: "Mantri", stringUrl: "/builders/bengaluru/mantri", stringId: "9_16", type: "BuilderDetail"}
  ]
  ...
  const radioorChecked=["status", "rera", "propertyType", "listingStatus", "PostedBy", "UsedorNotUsed", "PhotosVedios", "furnish"]
      ...
      {isOpen && (
        <div className="absolute top-full flex flex-col right-0 mt-2 min-w-[700px] bg-white rounded-lg shadow-lg border z-50 ">
          ...
          <div className='flex flex-col justify-start max-h-[60vh] overflow-y-auto'>
            ...
            <div className="p-6 flex flex-col items-start  flex-wrap justify-between   ">
            {renderFilterSection('Bathrooms', SEARCH_FILTER_DATA.Bathrooms, 'bathrooms',6)}
            {renderFilterSection('parking', SEARCH_FILTER_DATA.Parkings, 'prakings',6)}
            {renderFilterSection('Amenities', SEARCH_FILTER_DATA.amenities, 'amenities', 8)}
            {renderFilterSection('facings', SEARCH_FILTER_DATA.facing, 'facings',9)}
            {!isproject&&renderFilterSection('UsedorNotUsed', SEARCH_FILTER_DATA.UsedorNotUsed, 'UsedorNotUsed')}
            {!isproject&&renderFilterSection('PostedBy', SEARCH_FILTER_DATA.PostedBy, 'PostedBy')}

     ...
     {modalOpen &&
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center  p-4 z-50">
          ...
          <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              <button onClick={()=>{
                setModalOpen(false)
              }} type="button" className="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="successModal">
              ...
              <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Application successfully submitted</p>

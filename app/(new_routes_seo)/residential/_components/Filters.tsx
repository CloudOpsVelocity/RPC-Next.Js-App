      ...
      <div className="bg-card shadow-xl rounded-xl py-1 sm:p-6 z-[500] bg-white">
        <div className="grid  grid-cols-[1fr_1fr_1fr_auto] md:grid-cols-4 gap-1 md:gap-4">
          ...
          <div>
            ...
            <div  onClick={onSearch}  className="flex sm:hidden justify-center items-center rounded-[4px] py-[4px] px-[14px] sm:px-[6px] xl:py-[6px] xl:px-[16px] text-[12px] sm:text-[14px] text-white xl:text-[16px] font-bold bg-[#0073c6] cursor-pointer"><svg className="min-w-[18px] min-h-[18px] " xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none"><path stroke-width="2" d="M11.6849 12.6267C11.9533 12.895 12.3674 12.4808 12.0991 12.2183L9.91161 10.025C10.6791 9.1761 11.1033 8.07196 11.1016 6.92751C11.1016 4.36668 9.01911 2.28418 6.45827 2.28418C3.89744 2.28418 1.81494 4.36668 1.81494 6.92751C1.81494 9.48835 3.89744 11.5708 6.45827 11.5708C7.61328 11.5708 8.68078 11.145 9.49744 10.4392L11.6849 12.6267ZM2.39769 6.92751C2.39769 4.68751 4.22352 2.86751 6.45769 2.86751C8.69769 2.86751 10.5177 4.68751 10.5177 6.92751C10.5177 9.16751 8.69769 10.9875 6.45769 10.9875C4.22352 10.9875 2.39769 9.16751 2.39769 6.92751Z" fill="#FFFFFF"></path></svg></div>
            <button onClick={onSearch} className="md:w-[70%] hidden sm:flex bg-primary hover:bg-primary/90 p-3 items-center justify-center gap-2  bg-btnPrimary text-white text-[14px] md:text-[16px] py-[4px] px-[8px] md:py-[6px] md:px-[12px] rounded-[4px] font-[600]">
              <FaSearch />
              <span className=" text-[14px] md:text-[12px] lg:text-[14px] text-nowrap">Search Properties</span> 
            </button>

...
import { FaBuilding, FaMapMarkerAlt, FaCompass, FaCalendarAlt, FaCar, FaBath, FaExpandArrowsAlt } from "react-icons/fa"
    ...
    <div className="rounded-lg overflow-hidden h-full flex flex-col transition-all duration-200 hover:shadow-lg border border-gray-200">
        ...
        <div className="space-y-1">
          ...
          <Link
            ...
            href={ generateListingLinkUrl({
                      ...
                      projName: property.projIdEnc ? property.propName : null,
      ...
      <div className="p-4 flex-grow">
         <div className="flex items-center gap-2 xl:gap-x-4 xl:gap-y-0 self-stretch flex-wrap">
                    ...
                    {property.category == "Rent" && (
                      <DownSectionCard label={"Available For"} value={property.availableFor} />
                    )}
                  ...
                  {/*  <DownSectionCard
                      ...
                      {property.propTypeName != "Plot" && (
                        <DownSectionCard
                          label={"Parkings"}
                          value={property.parking && `${property.parking} No's (${property.coverParking})`}
                        />
                      )}
        ...
        <Button
            ...
            onChange={() => {
              open({
                ...
                postedByName: type === "proj" ? property.builderName : property.postedBy,
                postedId: property.builderId,
                reqId: property.projIdEnc?property.projIdEnc :property.propIdEnc ,
                source: type === "proj" ? "projCard" : "propCard",
                title:
                  type === "proj"
                    ? property.projName
                    : `${property.bhkName ?? ""} ${property.propTypeName} for
                ${property.cg === "R" ? "Rent" : "Sale"} in ${property.localityName}`,
              });
              // pushHistory();
            }}
          />
